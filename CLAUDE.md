...
### 키워드 편집 판단 기준
- **점주가 행동할 수 있는 것만** — 발주/진열/재고 확인 등
- **지난주에 다뤘어도 여전히 트렌드면 포함** — 단, 새로운 정보 없이 반복하지 말 것
- **검색량도 없고 SNS 반응도 약한 건 제외**
...
**HTML 작성 시 반드시 지킬 것:**
- **가격 일관성**: 가격을 넣으려면 모든 상품에 넣을 것. 일부만 넣고 일부는 빼면 안 됨
- **떡볶이 비교 노출 금지**: 떡볶이 기준선은 내부 판단 도구. 점주에게 "떡볶이의 N%" 같은 표현 절대 쓰지 말 것
- **검증 안 된 숫자 금지**: "매출 22배 급증", "180% 증가" 등은 기사 URL을 직접 열어서 확인한 것만 기재
- **영어 라벨 금지**: CHEF COLLAB 같은 영어 쓰지 말 것. 점주 독자층은 30~40대
- **상권 태그 차별화**: "2030 여성 비중이 높은 상권" 복붙 금지. 상품별로 왜 이 상권인지 다른 이유를 써야 함
- **CTA 구체적으로**: "재고를 점검하세요" 같은 막연한 말 대신 "라면 코너 OO 옆에 함께 진열하세요" 등
